...
/*
    html페이지 ㄹ딩이 완료된 이후에 코드를 실행하고자 할 때
     - window.onload사용
*/
window.onload = function(){
    // document.querySelector('#btn2').onclick = test1(); 함수를 호출해서 바인딩 시도
    document.querySelector("#btn2").onclick = test1; // 함수값 형태
    ...
    /*
        Event객체
         ...
         - 이벤트 발생 시 브라우저는 이벤트 핸들러 함수의 첫번째 매개변수로 항상
           이벤트 객체를 주입
        Event Target객체
         - 이벤트가 발생한 객체
